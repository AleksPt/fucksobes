...
Инструменты: Xcode Cloud (CI/CD от Apple, интегрирован с Xcode и TestFlight), GitHub Actions (workflow в YAML в `.github/workflows/`, выполняются на runner'ах, в том числе macOS).
