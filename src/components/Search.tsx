  ...
  return (
    <div className="ml-auto w-full max-w-sm sm:relative">
      <input
        ...
        onKeyDown={onKeyDown}
        className="w-full rounded-lg border border-zinc-200 bg-zinc-50 px-3 py-1.5 text-sm outline-none placeholder:text-zinc-500 focus:border-zinc-400 focus:bg-white dark:border-zinc-800 dark:bg-zinc-900 dark:placeholder:text-zinc-400 dark:focus:border-zinc-600 dark:focus:bg-zinc-950"
      />
      {open && (
        <ul
          id="search-results"
